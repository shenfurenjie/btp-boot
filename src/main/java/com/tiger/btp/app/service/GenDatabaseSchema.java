...
//    private InputStream table2xml(DataModelExt table) {
//        Map dataMap = new HashMap();
//        Map<String, Object> tableMap = new HashMap<>();
//        tableMap = getTableMap(table);
//        dataMap.put("table", tableMap);
//        InputStream inputStream = null;
//        try {
//            inputStream = TemplateTool.getTemplate("templates/databaseSchema.ftl", dataMap);
//        } catch (Exception e) {
//            e.printStackTrace();
//            throw new BaseException(e);
//        }
...
//    }
//
//    protected Map<String, Object> getTableMap(DataModelExt table) {
//        Map<String, Object> tableMap = new HashMap<>();
...
//        // 联合主键
//        List<Map<String, Object>> unionPks = Lists.newArrayList();
//        // 转换联合主键
//        Set<String> unionPk = new HashSet<>();
//        if (!StringUtils.isEmpty(table.getUnionPk())) {
//            String[] array = StringUtils.split(table.getUnionPk(), ",");
//            if (array != null) {
//                for (String upk : array) {
//                    if (StringUtil.hasText(upk)) {
//                        unionPk.add(upk.trim());
//                    }
//                }
//            }
//        }
//        List<Map<String, Object>> columns = Lists.newArrayList();
//        for (Attribute column : table.getAttribute()) {
//
//            String htype = ColumnTypeUtils.getHibernateType(ColumnType.valueOf(column.getType().name()));
//
//            Map<String, Object> columnMap = new HashMap<>();
//            columnMap.put("name", column.getName());
//            columnMap.put("hibernateType", htype);
//            columnMap.put("columnName", column.getColumnName() == null ? column.getName() : column.getColumnName());
//            columnMap.put("length", column.getLength());
//            columnMap.put("nullable", column.isNullable());
//            columnMap.put("unique", column.isUnique());
//
//            if (htype.endsWith("decimal")) {
//                columnMap.put("precision", column.getLength() <= 0 || column.getLength() == 255 ? 19 : column.getLength());
//            } else {
//                columnMap.put("precision", column.getLength());
//            }
//            columnMap.put("scale", column.getScale());
//            columnMap.put("defaultValue", column.getDefaultValue());
//            columnMap.put("label", column.getLabel() == null ? "" : column.getLabel());
//            if (table.getPkAttribute() != null && table.getPkAttribute().equals(column.getName())) {
//                pk = columnMap;
//            } else if (unionPk.contains(column.getName())) {
//                unionPks.add(columnMap);
//            } else {
...
//
//        tableMap.put("pk", pk);
//        tableMap.put("pkAuto", table.isPkAuto());
//        tableMap.put("unionPks", unionPks);
